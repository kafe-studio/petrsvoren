...
- [ ] Run 001 — Branding & layout (config, Navbar, Footer, hero) → docs/sprints/001-zaklad-galerie/run-001-branding-layout.md
- [ ] Run 002 — Datový model fotek (collection, sharp náhledy, ukázky)
